...
module.exports = class extends Generator {
  prompting() {
    ...
    const prompts = [
      ...
      },
      {
        ...
        default: 'ninjas',
        when: function(answers) {
          if (answers.autogen_pass === false) return true;
        }
      },
      {
        type: 'input',
    ...
    return this.prompt(prompts).then(props => {
      ...
      this.props = props;
      this.props.themeKey = _.kebabCase(this.appname);
      this.props.themeTitle = _.startCase(this.appname);
    });
  }
  ...
  configuring() {
    ...
    this.spawnCommandSync('git', [
      ...
      '--quiet',
      '--progress',
      'git@github.com:blenndiris/blennder.git',
      '.'
    ]);
    this.spawnCommandSync('git', [
      'clone',
      ...
      '--quiet',
      '--progress',
      'git@github.com:blenndiris/blennd-plugins.git',
      './wp-content/plugins/'
    ]);
    this.spawnCommandSync('mv', [
      './wp-content/themes/blennder',
      './wp-content/themes/' + this.props.themeKey
    ]);
    this.spawnCommandSync('rm', [
      '-rf',
      './wp-content/themes/' + this.props.themeKey + '/app/vendor/'
    ]);
  ...
  writing() {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath('./wp-content/themes/' + this.props.themeKey + '/style.css'),
      {
        theme: this.props.themeTitle
      }
    );
    this.fs.copyTpl(
  ...
  install() {
    ...
    if (this.props.type === 'MAMP') {
      ...
      this.spawnCommandSync('wp', ['theme', 'activate', this.props.themeKey]);
      ...
      this.spawnCommandSync('wp', [
        ...
        '--post_title=About',
        '--post_type=page',
        '--page_template=templates/template-page-builder.php'
      ]);
      this.spawnCommandSync('wp', [
        'post',
        'create',
      ...
      this.spawnCommandSync('wp', [
        ...
        '--post_type=page',
        '--page_template=templates/template-style-guide.php'
      ]);
      this.spawnCommandSync('wp', [
        'post',
        'create',
        '--post_status=publish',
        '--post_title=Form Styles',
        '--post_type=page',
        '--post_parent=7',
        '--page_template=templates/template-page-builder.php'
      ]);
      ...
      this.spawnCommandSync('wp', [
        ...
        '--force',
        '--activate',
        '--key=caf504634830d624fc6c035a16380114'
      ]);
      ...
      this.spawnCommandSync('wp', [
        ...
        'form',
        'import',
        this.templatePath('gf-test-forms.json')
      ]);
      this.spawnCommandSync('wp', [
        'plugin',
        'uninstall',
